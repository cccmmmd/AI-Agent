<img width="548" alt="image" src="https://github.com/user-attachments/assets/9104fb1d-a8c9-48fb-bac1-b12579556204" />
...
**出發前要查的資訊又多又雜，** 讓人焦慮！天氣、插座、換匯、街頭治安、文化禁忌...每件事都要花時間搜尋、理解、紀錄，最後彙整一份有用的文件更花心神！

這個專案把整個流程自動化：只需要輸入目的地、出發日期、旅客類型，三位領域專家 Agent 會依序展開調查，最後由主編 Agent 整合成一份針對該客群的完整 Markdown 行前報告。
