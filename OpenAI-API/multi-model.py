...
def summarize_content(content: str) -> str:
    response = client.responses.create(
        ...
        input=f"""
            ...
            Please provide a brief summary of the main points in the content. Using traditional Chinese. Prefer bullet points and avoid unncessary explanations.
        """
    )
